...
public class Regi_Nomina {
    ...
    public Regi_Nomina(Trabajador datos_Trabajador, Informe informe) {
        ...
        if (this.datos_Trabajador != null) {
            ...
            list_datos.add(String.valueOf(datos_Trabajador.getPension()*100 + "%"));
            list_datos.add(String.valueOf(datos_Trabajador.benSocial()*100+ "%"));
            

            list_datos.add(String.valueOf(datos_Trabajador.pagoVac()*100+ "%"));
            list_datos.add(String.valueOf(datos_Trabajador.Salud()*100+ "%"));
            list_datos.add(String.valueOf(datos_Trabajador.getAP()*100+ "%"));
